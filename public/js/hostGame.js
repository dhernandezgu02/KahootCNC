...
socket.on("GameOver", function (data) {
  ...
  document.getElementById("winner6").style.display = "block";
  document.getElementById("winner7").style.display = "block";
  document.getElementById("winner8").style.display = "block";
  ...
  document.getElementById("winner6").innerHTML = "6. " + data.num6;
  document.getElementById("winner7").innerHTML = "7. " + data.num7;
  document.getElementById("winner8").innerHTML = "8. " + data.num8;
});
